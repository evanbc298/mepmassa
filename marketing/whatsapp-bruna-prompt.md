...
**Status em 01/08/2026:** usuário confirmou que o sintoma continua (repete pergunta já respondida) e que ainda não checou a configuração de histórico do Facilita Flow abaixo — esse é o próximo passo, antes de qualquer novo ajuste de texto no prompt. Reforcei nesta versão (2.4) a regra de continuidade com uma checagem mental explícita de dados já coletados, mas isso é uma segunda camada — não substitui corrigir a causa raiz.
